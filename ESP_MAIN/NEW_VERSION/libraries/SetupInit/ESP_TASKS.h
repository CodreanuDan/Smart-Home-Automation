...
void TaskInitClass::espTaskCreate() /* Function that creates the tasks */
{
  ...
  /******************************************************************************************/
  /* Reads data from the LDR sensor. It's data is used in the other tasks                   */
  /******************************************************************************************/
  // xTaskCreatePinnedToCore(
  //   T_LDRReadTask,                                               /* Task function. */
  //   "LDRReadTask",                                               /* String with name of task. */
  //   STACK_SIZE_BYTES,                                            /* Stack size in bytes. */
  //   NULL,                                                        /* Parameter passed as input of the task */
  //   p_LDRReadTask,                                               /* Priority of the task. */
  //   &h_LDRReadTask,                                              /* Task handle to keep track of created task */
  //   0                                                            /* pin task to core 0 */
  // );
  // Serial.println("  >> Created Task: LDRReadTask");
  // delay(tc_objCreate_delay);
