...
/**
 * @brief Include the ArduinoBLE Library
 * 
 * This library provides functions to interact with the BLE devices.
 * It's used to communicate with the BLE devices.
...
void setup()
{
  ...
  /***********************************************************************************************************************************************************/
  /*________________________________________________________________WIFI_CONN_&_EVENTS_INIT:_________________________________________________________________*/
  /***********************************************************************************************************************************************************/ 
  /**
   * @brief Initialisation of the WiFi connection and events.
   */
  setupInit.wifiEventInit(); /* Inits the WiFi connection and events */
  delay(tc_moduleSetup_delay);
  ...
  if (f_setupInitFlag)
  {
    ...
    delay(tc_moduleSetup_delay * 50);
    lcd.clear();
  }
  else
  {
    Serial.println("###########################################################################################################################");
    Serial.println("#|____________________________________________________SETUP_FAILED_!_____________________________________________________|#");
    Serial.println("###########################################################################################################################");
    Serial.println("  ");
